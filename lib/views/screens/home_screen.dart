          ...
          child: Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: ( BuildContext context, int index) {
                return ListTile(
                  title: Text(list[index]['title'],style: const TextStyle(fontSize: 17,color: Colors.white),),
        ...
        body: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text('$name',style: const TextStyle(fontSize: 25,color: Colors.black),),
                    const SizedBox(height: 20,),
                    Text('$gmail',style: const TextStyle(fontSize: 20,color: Colors.black),),
                    const SizedBox(height: 20,),
                    CircleAvatar(
                      radius: 30,
